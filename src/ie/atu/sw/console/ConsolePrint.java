...
public class ConsolePrint {
    ...
    public static void printTitle(String title) {
        System.out.print(ConsoleColour.BLACK_BACKGROUND); // Set black background
        System.out.print(ConsoleColour.BLUE_BOLD); // Set bold blue text
        System.out.println(); // Print empty lines for spacing
        System.out.println();
        System.out.print("                         [TITLE] \n" + title); // Print stylized title with a leading label
        System.out.println();
        System.out.print(ConsoleColour.RESET); // Reset console colors
    }
    ...
    public static void printMenuOptions(String[] options) {
        System.out.print(ConsoleColour.BLACK_BACKGROUND); // Set black background
        System.out.print(ConsoleColour.CYAN_BOLD_BRIGHT); // Set bright cyan bold text
    ...
    public static void printConfigure(String setting) {
        System.out.print(ConsoleColour.BLACK_BACKGROUND); // Set black background
        System.out.print(ConsoleColour.SUNRISE_BOLD); // Set Sunrise colour text
        System.out.println();
        System.out.println();
    ...
    public static void printSection(String section) {
        System.out.print(ConsoleColour.BLACK_BACKGROUND); // Set black background
        System.out.print(ConsoleColour.ORANGE_BOLD); // Set orange colour text
        System.out.println();
        System.out.println();
    ...
    public static void printWithUnderline(String text) {
        ...
        System.out.print(ConsoleColour.YELLOW_UNDERLINED);
