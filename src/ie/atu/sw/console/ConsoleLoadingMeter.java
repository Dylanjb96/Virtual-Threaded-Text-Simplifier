...
public class ConsoleLoadingMeter {
    public static void printProgress(int index, int total) {
         ...
         */
        ConsoleColour consoleColor = ConsoleColour.RED;
        if (complete > 80)
            consoleColor = ConsoleColour.GREEN_BOLD_BRIGHT;
        else if (complete > 50)
            consoleColor = ConsoleColour.YELLOW_BRIGHT;

        System.out.print(
                "\r" + ConsoleColour.BLACK_BACKGROUND + consoleColor + sb + "] " + complete + "%");
